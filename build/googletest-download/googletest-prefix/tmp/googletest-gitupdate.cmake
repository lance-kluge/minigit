...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "release-1.10.0"
  WORKING_DIRECTORY "/Users/lancekluge/git/final-project-team-plz-work/build/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/lancekluge/git/final-project-team-plz-work/build/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/lancekluge/git/final-project-team-plz-work/build/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
